                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group {{ $errors->has('address2')? 'has-error':'' }}">
                            <label for="address2" class="col-sm-4 control-label">@lang('app.address2')</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="address2" value="{{ old('address2') }}" name="address2" placeholder="@lang('app.address2')">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group {{ $errors->has('zip_code')? 'has-error':'' }}">
                                    <label for="address" class="col-sm-6 col-md-offset-1 control-label">@lang('app.zip_code')</label>
                                    <div class="col-sm-5">
                            ...
                            <div class="col-md-5">
                                <div class="form-group {{ $errors->has('city')? 'has-error':'' }}">
                                    <label for="address" class="col-sm-3 control-label">@lang('app.city')</label>
                                    <div class="col-sm-9">
